...
public class TemplateController {
    ...
    public ResponseEntity<String> sendTemplate(@Valid @RequestBody TemplateDto templateDto) {
    ...
    public ResponseEntity<String> refreshEsl(@Valid @RequestBody RefreshDto refreshDto) {
